-- Add copyright column to gallery_items table
ALTER TABLE gallery_items 
ADD COLUMN IF NOT EXISTS copyright text DEFAULT '© سواليفهم - جميع الحقوق محفوظة';
...
CREATE TABLE IF NOT EXISTS gallery_items (
  ...
  copyright text DEFAULT '© سواليفهم - جميع الحقوق محفوظة',
