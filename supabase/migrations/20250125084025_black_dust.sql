...
DROP POLICY IF EXISTS "Anyone can read storytellers" ON storytellers;
DROP POLICY IF EXISTS "Users can update their own profile" ON storytellers;
DROP POLICY IF EXISTS "Users can delete their own profile" ON storytellers;
